    ...
    Column(
        ...
        Box(modifier = Modifier.fillMaxSize())
        {
            Box(modifier = Modifier.fillMaxSize())
            {
                ...
                Image(
                    painter = painterResource(Res.drawable.landing_perspective),
            ...
            Box(modifier = Modifier.fillMaxSize().background(Color.Transparent).alpha(1f)
                ...
                Column(
                    ...
                    AnimatedContent(
                        ...
                        Text(
                            ...
                            text = "Consulta el precio de miles de articulos a tu alrededor",
                            style = StyleBigTitle().copy(
